...
test_that("Test that read_data gives error for wrong section", {
  expect_error(read_data("new_protocol_no_field.csv", section = "Calibration"),
               "Couldn't find section named Calibration")
})

test_that("Test that read_data gives error for wrong channel", {
...
test_that("Test that read_data correctly converts the time", {
